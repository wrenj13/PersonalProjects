/**
 * An interface for a board of type E.
 * It is assumed to hold a two-dimensional array of type E.
 * 
 * @author Ren-Jay Wang
 *
 * @param <E>
...
public interface Board<E> {
	...
	/**
	 * Returns the value of the index in the array at the 
	...
	/**
	 * Sets the value of the index in the array to the 
	 * specified row and column.
	 * @param row the row of the desired index
	 * @param col the column of the desired index
